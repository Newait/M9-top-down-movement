...
@onready var _ui_panel_container: PanelContainer = $BlurColorRect/UIPanelContainer
...
@onready var _resume_button: Button = $BlurColorRect/UIPanelContainer/VBoxContainer/CenterContainer/VBoxContainer/ResumeButton
@onready var _quit_button: Button = $BlurColorRect/UIPanelContainer/VBoxContainer/CenterContainer/VBoxContainer/QuitButton
